...
var _base = require('./shopify/base');
		...
		value: function retriveAndCreateShop() {
			...
			return new _bluebird2.default(function (resolve, reject) {
				_this4.APIInterface.get('/admin/shop.json', function (err, data, headers) {
					...
					_this4.createStorefrontAccessToken().then(function (storefrontToken) {

						_this4.storefront_access_token = storefrontToken.storefront_access_token.access_token;
						...
						shop.save(function (err, shopData) {
							...
							var token = new _token2.default({
								...
								storefront_access_token: storefrontToken.storefront_access_token,
