...
var BaseShopifyService = function () {
	function BaseShopifyService(shop, access_token, nonce) {
		...
		this[_shopifyAPIConfig] = _config.API_CONFIG;
		this[_shopifyAPIConfig].shop = shop;

		this.myShopifyDomain = shop;

		if (nonce) {
			this[_shopifyAPIConfig].nonce = nonce;
		} else {
			this[_shopifyAPIConfig].nonce = _utils2.default.uid();
		}

		if (access_token) {
			this[_shopifyAPIConfig].access_token = access_token;
		}
	}
	...
	_createClass(BaseShopifyService, [{
		...
		set: function set(token) {
			this[_shopifyAPIConfig].access_token = token;
			return this;
		}
		...
		,
		get: function get() {
			return this[_shopifyAPIConfig].access_token || '';
		}
		...
		set: function set(url) {
			this[_shopifyAPIConfig].redirect_uri = url;
		}

		// get redirect URI
		,
		get: function get() {
			return this[_shopifyAPIConfig].redirect_uri;
		}
		...
		key: 'nonce',
		get: function get() {
			return this[_shopifyAPIConfig].nonce;
		}
		...
		key: 'APIInterface',
		get: function get() {
			return new _shopifyNodeApi2.default(this[_shopifyAPIConfig]);
		}
	}, {
		key: 'shop',
		set: function set(s) {
